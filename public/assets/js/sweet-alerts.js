...
$(document).ready(function () {
	...
	// Confirm Button Action
	$('#disable-outlet').on('click', function () {
		swal({
			title: 'Are you sure?',
			text: "Outlet will be disable!",
			type: 'warning',
			showCancelButton: true,
			confirmButtonColor: '#0CC27E',
			cancelButtonColor: '#FF586B',
	...
	// Confirm Button Action
	$('#enable-outlet').on('click', function () {
		swal({
			title: 'Are you sure?',
			text: "Outlet will be Enable!",
			type: 'warning',
			showCancelButton: true,
			confirmButtonColor: '#0CC27E',
			cancelButtonColor: '#FF586B',
