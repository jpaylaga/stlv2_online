                                ...
                                >
                                    <template slot="table-row" slot-scope="props">
                                        <span v-if="props.column.field == 'status'">
                                            <button @click="updateStatus(props.row)" class="btn btn-sm" :class="`btn-${getStatusClass(props.row.status)}`">{{props.row.status}}</button>
                                        </span>
                                    </template>
                                </vue-good-table>
                            </div>
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                ...
                columns: [
                    ...
                    { label: 'Type', html: true, field: this.getTransType },
                    { label: 'Via', field: 'outlet' },
                    { label: 'Amount', field: 'amount' },
                    { label: 'Member', html: true, field: this.getMember },
        ...
        methods: {
            ...
            getTransType(item){
                return `<span class="badge badge-${(item.type == 'deposit' ? 'success' : 'danger')}">${item.type}</span>`;
            },
            getMember(item){
