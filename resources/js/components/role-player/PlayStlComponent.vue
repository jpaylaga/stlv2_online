                        ...
                        <form class="form addbet" @submit.prevent="save">
                            <div class="form-body">
                                ...
                                <div class="form-group row mt-2 mb-1">
                                    ...
                                    <div class="col-md-12">
                                        <input readonly @click="focused_input='combination'" @focus="focused_input='combination'" name="combination" v-model="bet.combination" type="text" class="form-control" :class="focused_input == 'combination' ? 'focused_input' : ''">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input readonly @click="focused_input='amount'" @focus="focusInput('amount')" name="amount" v-model="bet.amount" type="number" min="1" max="999" class="form-control" :class="focused_input == 'amount' ? 'focused_input' : ''">
                                    </div>
                                </div>
