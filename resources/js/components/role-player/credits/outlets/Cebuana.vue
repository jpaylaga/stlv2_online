    ...
    <div class="card">
        <div class="card-body">
            <div class="card-block">
                ...
                <form class="form" @submit.prevent="submitCebuana">
                    <div class="form-body">
                        <center class="mb-1">
                            <img class="rounded img-thumbnail mb-2" :src="`/images/outlets/cebuana.jpg`" alt="cebuana">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input name="amount" v-model="cebuana.amount" type="number" min="200" max="10000" class="form-control" required>
                            </div>
                            <div class="col-md-12 mb-2">
                                <center> <label class="mb-0" for="sender">Sender Name</label> </center>
                                <input name="sender" v-model="cebuana.sender" type="text" class="form-control" required>
                            </div>
                            <div class="col-md-12 mb-2">
                                <center> <label class="mb-0" for="receiver">Receiver Name</label> </center>
                                <select v-model="cebuana.receiver" class="form-control" required>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input name="ref" v-model="cebuana.ref" type="text" class="form-control" required>
                            </div>
                            <div class="col-md-12 mb-2">
                                <center> <label class="mb-0" for="description">Notes</label> </center>
                                <textarea name="description" v-model="cebuana.description" class="form-control"></textarea>
                            </div>
...
export default {
    ...
    methods: {
        init(){
            this.cebuana.player_id = this.player_id
            this.loadReferences();
        },
        ...
        submitCebuana(){
            this.isLoading = true;
            axios.post('/api/credits/topup', this.cebuana).then(resp => {
